    ...
    public partial class SlicerPanel : UserControl
    {
        ...
        public void UpdateSelection()
        {
            ...
            if (di.Exists)
            {
                ...
                comboSlic3rFilamentSettings.Enabled = Main.connection.numberExtruder>0;
                comboSlic3rFilamentSettings2.Enabled = Main.connection.numberExtruder > 1;
                comboSlic3rFilamentSettings3.Enabled = Main.connection.numberExtruder > 2;
