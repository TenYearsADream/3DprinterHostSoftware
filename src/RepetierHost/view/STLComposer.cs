...
//        public ThreeDView stlThreeDView;
...
//                //  cont.Height = Height;
//                //  Controls.Add(cont);
//                stlThreeDView.SetEditor(true);
//                stlThreeDView.objectsSelected = false;
//                stlThreeDView.eventObjectMoved += objectMoved;
//                stlThreeDView.eventObjectSelected += objectSelected;
//                stlThreeDView.autoupdateable = true;
//                updateEnabled();
//                if (Main.main != null)
//                {
...
//                stlThreeDView.models.AddLast(stl);
...
//            foreach (STL s in stlThreeDView.models)
//            {
...
//            {
//                stlThreeDView.models.Remove(stl);
